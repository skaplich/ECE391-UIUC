...
//helper functions for scrolling, backspace, new line
int get_screen_x();
int get_screen_y();
int fish_num;
...
int get_num_rows();
void test_freq(void);
void cursorback(void);//moves cursor one char back
void clear_screen(void);//clear screen and move cursor to top left
void scrolling(void);//scrolling implementation
